	...
	public View(Stage theStage) {
        ...
        theScene.setOnKeyPressed(new EventHandler<KeyEvent>(){
        	...
        	public void handle(KeyEvent key) {
        		switch(key.getCode()) {
        		case UP:
        			if (di == Direction.SOUTH||di == Direction.NORTHWEST||di == Direction.NORTHEAST) {
        				di = Direction.NORTH;
        			}
        			if (di == Direction.EAST||di == Direction.SOUTHEAST) {
        				di = Direction.NORTHEAST;
        			}
        			if (di == Direction.WEST||di == Direction.SOUTHWEST) {
        				di = Direction.NORTHWEST;
        			}
        			break; 
        		case DOWN:
        			if (di == Direction.NORTH||di == Direction.SOUTHWEST||di == Direction.SOUTHEAST) {
        				di = Direction.SOUTH;
        			}
        			if (di == Direction.NORTHWEST||di == Direction.WEST) {
        				di = Direction.SOUTHWEST;
        			}
        			if (di == Direction.NORTHEAST||di == Direction.EAST) {
        				di = Direction.SOUTHEAST;
        			}
        			break;
        		case LEFT:
        			if (di == Direction.EAST||di == Direction.SOUTHWEST||di == Direction.NORTHWEST) {
        				di = Direction.WEST;
        			}
        			if (di == Direction.NORTH||di == Direction.NORTHEAST) {
        				di = Direction.NORTHWEST;
        			}
        			if (di == Direction.SOUTH||di == Direction.SOUTHEAST) {
        				di = Direction.SOUTHWEST;
        			}
        			break;
        		case RIGHT:
        			if (di == Direction.NORTHEAST||di == Direction.WEST||di == Direction.SOUTHEAST) {
        				di = Direction.EAST;
        			}
        			if (di == Direction.NORTH||di == Direction.NORTHWEST) {
        				di=Direction.NORTHEAST;
        			}
        			if (di == Direction.SOUTH||di == Direction.SOUTHWEST) {
        				di = Direction.SOUTHEAST;
        			}
        			break;
        		case A:
